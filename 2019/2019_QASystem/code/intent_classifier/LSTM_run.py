...
if __name__ == '__main__':
    ...
    train_len = int(len(content2id_list)*0.8)
    trainid_list = content2id_list[:train_len]
    train_list = content_list[:train_len]
    ...
    testid_list = content2id_list[train_len:]
    test_list = content_list[train_len:]
