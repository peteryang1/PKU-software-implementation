from intent_classifier import IntentModel
...
if __name__ == '__main__':
    ...
    for index in range(len(contentid_match_list)):
        ...
        for i in range(3000):
            ...
            _, train_loss, train_accuracy = model.train_step([batch_train_x, batch_train_y])
            batch = i + 1
            '''if batch % 50 == 0:
            ...
            if batch % 100 == 0:
                ...
                dev_loss, dev_accuracy, dev_predictions, dev_real = model.dev_step([batch_dev_x, batch_dev_y])
        ...
        test_loss, test_accuracy, test_predictions, test_real = model.dev_step([batch_test_x, batch_test_y])
