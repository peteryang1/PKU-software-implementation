...
Page({
  ...
  //跳转到免费书籍列表页
  toAllCultures:function(){
    wx.navigateTo({
      url: '../../pages/freeBooks/freeBooks',
    })
  },

  toAllExhibitions: function () {
    wx.navigateTo({
      url: '../../pages/allExhibitions/allExhibitions',
    })
  },

  toAllGraduations: function () {
    wx.navigateTo({
      url: '../../pages/allGraduations/allGraduations',
    })
  },
