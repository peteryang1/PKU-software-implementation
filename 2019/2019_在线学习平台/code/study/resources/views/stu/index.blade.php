        ...
        <div class="row">
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-aqua">
                    <div class="inner">
                        <h3 style="font-size: 20px">最近加入班级:
                            @if($classe)
                                {{$classe->name}}
                            @else
                                无
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                    <div class="inner">
			<h3 style="font-size: 20px">获得分数:@if($stuhomework)
                                {{$stuhomework->fraction}}
                            @else
                                0
                            @endif</h3>

		 <!--<h3 style="font-size: 20px">分数</h3>-->
                    </div>
                    <!--<div class="icon">
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-yellow">
                    <div class="inner">
                        <h3 style="font-size: 20px">文件数量:&nbsp;{{$file}}</h3>
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-red">
                    <div class="inner">
                        <h3 style="font-size: 20px">消息数量:&nbsp;{{$messages}}</h3>
		    ...
		    -->
                    <a href="{{route('messages.index')}}" class="small-box-footer">更多 <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
        </div>
